...
namespace DotNetNote.Models
{
    public class DbRepository
    {
        ...
        public void Add(Note vm)
        {
            ...
            {
                BoardLibrary.LOGGER.Error($"게시판 글쓰기 예외 발생 : {ex}");
        ...
        public int UpdateNote(Note vm)
        {
            ...
            {
                BoardLibrary.LOGGER.Error($"예외 발생 : {ex}");
            }
            return r;
        }
        ...
        #endregion NoteComments 테이블 처리영역
    }
}