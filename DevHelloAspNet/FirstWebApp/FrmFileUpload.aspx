    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div>
                ...
                <asp:Localize ID="LblLocal2" runat="server" Text="<hr /><b>안녕하세요</b>"></asp:Localize>
                <asp:Localize ID="LblLocal3" runat="server" Text="<hr /><b>안녕하세요</b>" Mode="Encode"></asp:Localize>
                <asp:Localize ID="LblLocal4" runat="server" Text="<hr /><b>안녕하세요</b>" Mode="Transform"></asp:Localize>
            </div>
        </div>
    </form>
</body>
